...
async def youtube_dl_call_back(bot, update):
    ...
    ad_string_to_replace = "please report this issue on https://www.instagram.com/ivenkatraj . Make sure you are using the latest version; see  https://www.instagram.com/ivenkatraj on how to update."
