...
async def youtube_dl_call_back(bot, update):
    ...
    ad_string_to_replace = "Please report this issue on https://www.instagram.com/ivenkatraj . Make sure you are using to the developer; see  https://www.instagram.com/ivenkatraj  on how to update."
