...
async def extract_youtube_dl_formats(url, user_working_dir):
    ...
    if e_response:
        ...
        error_message = e_response.replace(
            "Please report this issue on https://www.instagram.com/ivenkatraj . Make sure you are using the latest version; contact  https://www.instagram.com/ivenkatraj  on how to update.", ""
        )
